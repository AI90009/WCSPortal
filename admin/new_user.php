                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="user_fullnames" id="user_fullnames" class="form-control" placeholder="Add Name ">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label>User Name</label>
                                        <input type="text" class="form-control" name="usernames" id="usernames"  placeholder="Enter User Name">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label>Phone</label>
                                        <input type="text" name="user_phone" id="user_phone" class="form-control" placeholder="Enter Phone Number">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="pass-group">
                                            <input type="password" name="user_pass" id="user_pass" class="form-control pass-input" placeholder="*********">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="pass-group">
                                            <input type="password" name="user_cpass" id="user_cpass" class="form-control pass-inputs" placeholder="*********">
                                        ...
                                        <ul class="custom-radiosbtn">
                                            <li>
                                                <label class="radiossets">Active
                                                    <input type="radio" checked  name="user_state" id="user_state" value="Active">
                                                    <span class="checkmark-radio"></span>
                                                </label>
                                            </li>
                                            <li>
                                                <label class="radiossets">Inactive
                                                    <input type="radio" name="user_state" id="user_state" value="Inactive">
                                                    <span class="checkmark-radio"></span>
                                                </label>
                                            </li>
                                        </ul>
